...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/NHo.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/NHo.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '880087645').split()] # Replace with the actual admin ID(s) to add
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002396553917'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-100'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002396553917'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-2308503592')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002311778305')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-2308503592').split()]
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/NHo.jpg')
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002396553917'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/demoshort')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', '921449290530eaebb17713b180e695475307321d"')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/demoshort')  # Tutorial video link for opening shortlink website
...
OWNERID = int(os.environ.get('OWNERID', '880087645'))  # Replace with the actual admin ID
